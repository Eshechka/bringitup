...
/* harmony import */ var _modules_slider_BigSlider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider/BigSlider */ "./src/js/modules/slider/BigSlider.js");
...
document.addEventListener("DOMContentLoaded", function () {
  var sliderMainPage = new _modules_slider_BigSlider__WEBPACK_IMPORTED_MODULE_3__["default"]({
    containerSelector: ".page",
    nextSelector: ".next",
    clickToBeginSelector: '[data-link-logo="true"]'
  });
  sliderMainPage.init();
  var sliderMiniShowup = new _modules_slider_MiniSlider__WEBPACK_IMPORTED_MODULE_4__["default"]({
  ...
  var sliderMiniModules = new _modules_slider_MiniSlider__WEBPACK_IMPORTED_MODULE_4__["default"]({
  ...
  var sliderMiniFeed = new _modules_slider_MiniSlider__WEBPACK_IMPORTED_MODULE_4__["default"]({
  ...
  sliderMiniFeed.init();
  var player = new _modules_Player__WEBPACK_IMPORTED_MODULE_2__["default"]("frame", '.showup [data-play-btn="true"]', ".overlay");
  player.init();
  new _modules_Difference__WEBPACK_IMPORTED_MODULE_0__["default"](".officerold", ".officer__card-item", ".plus").init();
  new _modules_Difference__WEBPACK_IMPORTED_MODULE_0__["default"](".officernew", ".officer__card-item", ".plus").init();
  new _modules_Form__WEBPACK_IMPORTED_MODULE_1__["default"](".form");
});
...
/*#__PURE__*/
function () {
  function Difference(containerSelector, itemSelector, btnPlusSelector) {
    _classCallCheck(this, Difference);

    this.container = document.querySelector(containerSelector);
    this.items = this.container.querySelectorAll(itemSelector);
    this.controlItem = this.container.querySelector('[data-control-item="true"]');
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function postForm(url, data) {
      var res;
      return regeneratorRuntime.async(function postForm$(_context) {
        while (1) {
    ...
    value: function handleForm() {
      ...
      this.postForm("./assets/question.php", formData).then(function (res) {
    ...
    value: function init() {
      ...
      this.form.addEventListener("submnit", function () {
        return _this.handleForm();
      });
    }
  }]);
...
/***/ "./src/js/modules/slider/BigSlider.js":
/*!********************************************!*\
  !*** ./src/js/modules/slider/BigSlider.js ***!
  \********************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_Slider) {
  _inherits(BigSlider, _Slider);

  function BigSlider(_ref) {
    var containerSelector = _ref.containerSelector,
        nextSelector = _ref.nextSelector,
        clickToBeginSelector = _ref.clickToBeginSelector;

    _classCallCheck(this, BigSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(BigSlider).call(this, {
  ...
  _createClass(BigSlider, [{
    key: "toBegin",
    value: function toBegin() {
      var _this = this;

      this.beginizers.forEach(function (beginizer) {
        beginizer.addEventListener("click", function () {
          _this.currentSlideNumber = 1;

          _this.showSlide(_this.currentSlideNumber);
        });
      });
    }
  }, {
    key: "normaliseCurrentSlide",
    value: function normaliseCurrentSlide(plus) {
      var remain = plus % this.slides.length;
    ...
    key: "changeSlide",
    value: function changeSlide(howMuchSlidesPlus) {
    ...
    value: function init() {
      ...
      this.next.forEach(function (nextBtn) {
      ...
      try {
        ...
        this.slideHanson = this.container.querySelector("[data-hanson-parent='true']");
...
/* harmony default export */ __webpack_exports__["default"] = (BigSlider);
...
/*#__PURE__*/
function (_Slider) {
  _inherits(MniSlider, _Slider);

  function MniSlider(_ref) {
    var containerSelector = _ref.containerSelector,
    ...
    _classCallCheck(this, MniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MniSlider).call(this, {
      containerSelector: containerSelector,
  ...
  _createClass(MniSlider, [{
    ...
    key: "changeSlide",
    value: function changeSlide(howMuchSlidesPlus) {
      for (var j = 0; j < Math.abs(howMuchSlidesPlus); j++) {
    ...
    value: function init() {
      ...
      this.prev.forEach(function (prevBtn) {
...
/* harmony default export */ __webpack_exports__["default"] = (MniSlider);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      containerSelector = _ref$containerSelecto === void 0 ? null : _ref$containerSelecto,
      _ref$slideSelector = _ref.slideSelector,
      slideSelector = _ref$slideSelector === void 0 ? null : _ref$slideSelector,
      ...
      _ref$clickToBeginSele = _ref.clickToBeginSelector,
      clickToBeginSelector = _ref$clickToBeginSele === void 0 ? null : _ref$clickToBeginSele,
